 ...
 * 2. Add unique prefix for the class name, e.g. - Twentyseventeen_Jet_Design_Kit_CX_Loader
 ...
 *     new Twentyseventeen_Jet_Design_Kit_CX_Loader(
 *         array(
...
if ( ! class_exists( 'Jet_Design_Kit_CX_Loader' ) ) {

	/**
	 * Define Jet_Design_Kit_CX_Loader class
	 */
	class Jet_Design_Kit_CX_Loader {
