...
abstract class Jet_Design_Kit_Templates_Source_Base {
	...
	*/
	...
	public function templates_key() {
		return 'jet_design_kit_templates_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function categories_key() {
		return 'jet_design_kit_categories_' . $this->get_slug() . '_' . $this->get_version();
	}
	...
	public function keywords_key() {
		return 'jet_design_kit_keywords_' . $this->get_slug() . '_' . $this->get_version();
	}
