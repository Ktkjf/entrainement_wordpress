...
function() {
    ...
    var l, a, e, t, d, s, c, p, r, u, h, f, m, g, v, i, y, w, n, o, x, T, C, S, _, E, k, I, A, D, M, z, P, O, L, N, H, B, W, j, Y, R, $, F, X, q, G, V, Q, K, U, Z, J, ee, te, ie, ne, ae, oe, se, re, le, de, ce, pe, ue, he, fe, me, ge, ve, ye, we, be, xe, Te, Ce, Se, _e, Ee, ke, Ie, Ae, De, Me, ze, Pe, Oe, Le, Ne, He, Be, We, je, Ye, Re, $e, Fe, Xe, qe, Ge, Ve, Qe, Ke, Ue, Ze, Je, et, tt, it, nt, at, ot, st, rt, lt, dt, ct, pt, ut, ht, ft, mt, gt, vt, yt, wt, bt, xt, Tt, Ct, St, _t, Et, kt, It, At, Dt, Mt, zt, Pt, Ot, Lt, Nt, Ht, Bt, Wt, jt, Yt, Rt, $t, Ft, Xt, qt, Gt, Vt, Qt, Kt, Ut, Zt, Jt = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        ...
        }, I = "dropdown-item", A = "active", D = '[data-spy="scroll"]', M = ".active", z = "li", P = ".nav-link", O = ".dropdown", L = ".dropdown-item", N = ".dropdown-toggle", H = "offset", B = "position", W = function() {
            function n(e, t) {
                var i = this;
        ...
        }, s = "dropdown-menu", c = "active", p = "disabled", r = "fade", u = "show", h = ".dropdown", f = "ul:not(.dropdown-menu), ol:not(.dropdown-menu), nav:not(.dropdown-menu)", m = "> .nav-item .fade, > .fade", g = ".active", v = "> .nav-item > .active, > .active", i = '[data-toggle="tab"], [data-toggle="pill"]', y = ".dropdown-toggle", w = "> .dropdown-menu .active", n = function() {
            function n(e) {
                b(this, n), this._element = e
            }
...
function(s, o, a, r) {
    ...
    }, s(a).on("ready.px.parallax.data-api", function() {
    ...
    function(e, t) {
        ...
        $(".swiper-container").each(function() {
            var e = {
                ...
                t = $(this);
            t.find(".swiper-button-next").length && (e.nextButton = ".swiper-button-next"), t.find(".swiper-button-prev").length && (e.prevButton = ".swiper-button-prev"), t.find(".swiper-pagination").length && (e.pagination = ".swiper-pagination", e.paginationClickable = !0), e = $.extend(e, page.getDataOptions(t)), new Swiper(t, e)
        })
...
(function( $ ) {
	...
	bewmobilefirst.shop = function() {
		...
		var $BmfdEnabled = $('.bew-mobile-first-yes');
