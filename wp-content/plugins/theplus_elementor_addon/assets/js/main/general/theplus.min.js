...
/*equal height*/(function(a){a.fn.equalHeights=function(){var b=0;a(this).each(function(){b=Math.max(a(this).height(),b)}),a(this).each(function(){a(this).css("min-height",b)})},a(document).ready(function(){var b=a(".elementor-element[data-tp-equal-height-loadded]");b.length&&b.each(function(){var b=a(this).data("id"),c=a(this).data("tp-equal-height-loadded");a(".elementor-element-"+b+" "+c).equalHeights()})}),a(window).on("load resize",function(){var b=a(".elementor-element[data-tp-equal-height-loadded]");b.length&&b.each(function(){var b=a(this).data("id"),c=a(this).data("tp-equal-height-loadded");a(".elementor-element-"+b+" "+c).equalHeights()})})})(jQuery);

/*product listing yith*/(function(a){"use strict";var b=function(a){var b=a.find(".product-list .tp-yith-wrapper .post-yith-wc-quickview");b.length&&(b.find(".button").html("<i aria-hidden=\"true\" class=\"fas fa-eye\"></i>"),b.css("opacity","1"))};a(window).on("elementor/frontend/init",function(){elementorFrontend.hooks.addAction("frontend/element_ready/tp-product-listout.default",b)})})(jQuery);

/*chart js*/!function(t){"use strict";function n(t,n){var e=t.find(".tp-chart-wrapper"),o=e.find("> canvas"),r=e.data("settings");e.length&&elementorFrontend.waypoint(o,function(){var t=n(this)[0].getContext("2d");new Chart(t,r)},{offset:"bottom-in-view"})}t(window).on("elementor/frontend/init",function(){elementorFrontend.hooks.addAction("frontend/element_ready/tp-chart.default",n)})}(jQuery);
