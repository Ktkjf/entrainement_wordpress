					...
					$(document).ready(function() {
						...
						var hscroll_elem = $.jInvertScroll([".tp_hscroll_scrollable"],
							...
							onScroll: function(percent) {
								...
								if(pageWrapper.length){
									...
									var arry_index = [];
									$(".elementor-"+parent_id+"> .elementor-section-wrap > .elementor-element .tp_horizontal_scroll  .tp_hscroll_slide").each(function(){
										var el = $(this);
						...
						var hscroll_checkresponsive = function(){
							...
							if (window_width > '.$hscroll_res_minwidth.') {
								...
								$("a[href*=foo]").off("click", closeAnimation);
								$("a[href*=foo]").on("click", hscroll_Animation);
								...
								$("a[href*=foo]").off("click", hscroll_Animation);
								$("a[href*=foo]").on("click", closeAnimation);
