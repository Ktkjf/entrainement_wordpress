...
class ThePlus_Product_ListOut extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__('YITH Buttons', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'display_yith_list' => 'yes',
				],				
		...
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__('YITH Buttons Box', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'display_yith_list' => 'yes',
				],				
	...
	protected function get_carousel_options() {
		...
		$data_slider ='';
			...
			$data_slider .=' data-autoplay_speed="'.esc_attr(!empty($settings["autoplay_speed"]["size"]) ? $settings["autoplay_speed"]["size"] : '').'"';
