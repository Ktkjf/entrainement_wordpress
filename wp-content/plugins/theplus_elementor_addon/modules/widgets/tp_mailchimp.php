    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Thanks for Subscribing with us. Please Check Email and Conform to Subscribe.', 'theplus' ),
				'placeholder' => esc_html__( 'Thanks for Subscribing with us. Please Check Email and Conform to Subscribe.', 'theplus' ),
				'label_block' => true,
				'dynamic' => ['active'   => true,],
				'condition' => [
	 ...
	 protected function render() {
		...
		$double_opt_in_msg=(!empty($settings['double_opt_in_msg'])) ? $settings['double_opt_in_msg'] : 'Thanks for Subscribing with us. Please Check Email and Conform to Subscribe.';
