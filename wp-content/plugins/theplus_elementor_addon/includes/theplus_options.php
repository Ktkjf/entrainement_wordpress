            ...
            'fields' => array(
				array(
	                ...
	                'options' => array(
						...
						'tp_chart' => esc_html__('Chart', 'theplus'),
						...
						'tp_dark_mode' => esc_html__('Dark Mode', 'theplus'),
						...
						'tp_hovercard' => esc_html__('Hover Card', 'theplus'),
	                    ...
	                    'tp_meeting_scheduler' => esc_html__('Meeting Scheduler', 'theplus'),
