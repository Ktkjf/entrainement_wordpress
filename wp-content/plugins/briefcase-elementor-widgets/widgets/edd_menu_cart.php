...
class BEW_Widget_Edd_Menu_Cart extends Widget_Base {

	public function get_name() {
		return 'bew-edd-menu-cart';
	}

	public function get_title() {
		return __( 'Edd Menu Cart', 'briefcase-elementor-widgets' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'quantity_bg_color',
			[
				'label' 		=> __( 'Quantity Background', 'briefcase-elementor-widgets' ),
		...
		$this->add_control(
			'quantity_links_color',
			[
				'label' 		=> __( 'Links Color', 'briefcase-elementor-widgets' ),
				'type' 			=> Controls_Manager::COLOR,
				'default' 		=> '#b7b7b7',
				'selectors' 	=> [
					'{{WRAPPER}} #custom-header-add-cart a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			'quantity_links_hover_color',
			[
				'label' 		=> __( 'Links Color', 'briefcase-elementor-widgets' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
					'{{WRAPPER}} #custom-header-add-cart a:hover' => 'color: {{VALUE}};',
				],
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new BEW_Widget_Edd_Menu_Cart() );