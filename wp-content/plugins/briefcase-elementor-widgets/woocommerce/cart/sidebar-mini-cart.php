							...
							<div class="owp-grid-wrap">
								...
								<div class="owp-grid content">
									<div class="bewwoo-content-wrap">
										...
										<?php echo apply_filters( 'woocommerce_widget_cart_item_quantity', '<span class="bew-price-minicart">' . sprintf( '<span class="bew-quantity quantity">%s &times;</span> %s', $cart_item['quantity'], $product_price ) . '</span>', $cart_item, $cart_item_key ); ?>
...
<?php else : ?>
	<div class="bew-empty-cart"><img src="<?php echo BEW_ASSETS_URL .'img/empty.png' ?>">
